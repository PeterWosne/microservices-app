package ru.ermakov.market.cart.configs;
...
import ru.ermakov.market.cart.properties.ProductServiceIntegrationProperties;
...
public class AppConfig {
    ...
    public WebClient productServiceWebClient() {
        ...
        TcpClient tcpClient = TcpClient
                .create()
                .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, productServiceIntegrationProperties.getConnectTimeout()) //таймаут для подключения
...
//    RestTemplate нужен для отправки запросов
//    Но это старая технология -> синхронный клиент(когда мы отправляем запрос, мы ждем получения данных и поток блокируется)
